...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=react,redux,tailwind,nodejs,express,mongodb,python,git,vscode,html,css,js&perline=12&theme=dark" />
  </a>
</p>
...
- 🎨 **Pixel-Perfect UIs** with React & Tailwind
- 🔄 **Complex State Management** using Redux
- ⚡ **Performant APIs** with Node.js & Express
- 🗄️ **Scalable Databases** on MongoDB
...
const life = {
    ...
    tools: ["React", "Node", "MongoDB", "Redux"],
    askMeAbout: ["web dev", "animations", "state management", "clean code"],
    hobbies: ["Exploring new tech", "UI/UX design", "Open source"]
};
```
